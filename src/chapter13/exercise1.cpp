...
int main()
{
    ...
    Shader lightShader("src/shaders/vertex_shader_light.glsl",
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        float radius = 5.0f;
        float theta = 50 * glm::radians(90.0f) * sin(glfwGetTime());
        float phi = 50 * glm::radians(90.0f) * cos(glfwGetTime()) * cos(glfwGetTime());
        lightSourcePosition = glm::vec3(radius * sin(glm::radians(phi)) * cos(glm::radians(theta)),
