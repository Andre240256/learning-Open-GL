...
int main()
{
    ...
    //textures
    //--------------------
    unsigned int diffuseMap = loadTexture("src/textures/bricks/brick.png");
    unsigned int normalMap = loadTexture("src/textures/bricks/brick_normal.png");
    unsigned int heightMap = loadTexture("src/textures/bricks/brick_disp.png");

    //load cube vao
    //---------------------
    GLuint vao = loadCube();
   
    //light spaces transforms
    //----------------------
    ...
    shader.setInt("material.texture_depth1", 2);
...
//load cube buffers and returns VAO
//-----------------------------------------------------------------------
GLuint loadCube()
{
    //cube data
